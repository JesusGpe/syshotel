...
public class frmEmpleados extends JInternalFrame {
	...
	public frmEmpleados() {
		...
		button_3.setIcon(new ImageIcon(frmEmpleados.class.getResource("/recursos/eliminar.png")));
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"1", "AURORA PEREZ", "ANGOSTURA SINALOA", "697110251154", "aurora@gmail.com", "03-05-1992", "MEXICANA", "AUPE03"},
			},
			new String[] {
				"ID", "NOMBRE", "DIRECCION", "TELEFONO", "CORREO ELECTRONICO", "FECHA NACIMIENTO", "NACIONALIDAD", "USUARIO"
			}
		));
		...
		btnNewButton.setIcon(new ImageIcon(frmEmpleados.class.getResource("/recursos/nuevo.png")));
		...
		btnGuardar.setIcon(new ImageIcon(frmEmpleados.class.getResource("/recursos/guardar.png")));
		
		JButton btnCancelar = new JButton("Cancelar");
		btnCancelar.setIcon(new ImageIcon(frmEmpleados.class.getResource("/recursos/cancelar.png")));
		...
		textField_7.setBackground(new Color(224, 255, 255));
		...
		textField_8.setBackground(new Color(224, 255, 255));
				...
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(textField_7, GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblContrasea, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(textField_8, GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
							.addContainerGap())))
		);
